...
export interface WarpEffectSettings {
  vignette: number
  darkness: number
  spiralGap: number
...
export interface WarpPointData {
  placedObjectPrefix: string
  panelX: number
  panelY: number
  sourceTimeline: string | null
  destTimeline: string | null
  ...
  effect: WarpEffectSettings
  cycleSpawnedOn: number
  cycleExpiry: number
  deathPersistent: boolean
  oneWay: boolean
  rippleWarp: boolean
  oneWayEntrance: boolean
  oneWayEntranceIdentified: boolean
  limitedUse: boolean
  uses: number
  weaverTriggeredCycle: number
  wasNonDynamicWarpBeforeWeaverTriggered: boolean
  unrecognizedAttributes: string[]
  isStatic: boolean
  isDynamic: boolean
  isOneWayExit: boolean
  destRegionDerived: string | null
}

export interface WarpPointEntry {
  roomName: string
  timeline: string
  uuidPair: string
  data: WarpPointData
...
export interface DeathPersistentSaveData {
  ...
  visitBath: boolean
  warpPoints: WarpPointEntry[]
  newWarpPoints: WarpPointEntry[]
  unrecognizedTokens: string[]
}
