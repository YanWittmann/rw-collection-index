...
export function DialogueBox({ pearl, selectedTranscriber, onSelectTranscriber }: DialogueBoxProps) {
        ...
        <div className="flex-1 relative">
            <div
                ...
                {pearl ? (
                    ...
                    <div className="text-center mt-16">Select a pearl to view its dialogue</div>
                )}
            </div>
            <motion.div
                initial={{ opacity: 0 }}
